...
public class LecManage extends javax.swing.JFrame {
    ...
    public LecManage() {
        initComponents();
        lec.fillLecturerJtable(jTable1, "");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lecturer ID", "First Name", "Last Name", "Address", "Contact", "Room", "Teaching Subject"
            }
        ));
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        ...
        jTable1.setModel(new DefaultTableModel(null,new Object[]{"Lecturer ID", "First Name", "Last Name", "Address",
                                                                "Contact", "Room", "Teaching Subject"}));
        lec.fillLecturerJtable(jTable1, jTextField_Search.getText()); 
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField_lecid.setText(model.getValueAt(rowIndex,0).toString());
    ...
    public boolean verifText(){
        if (jTextField_Fname.getText().equals("") || jTextField_Lname.getText().equals("") 
                ...
                || jTextField_lecid.getText().equals("")){
    ...
    private void jButton_Edit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit1ActionPerformed
        ...
        int lecid = Integer.valueOf(jTextField_lecid.getText());
        ...
        if(verifText()){
            ...
            Lecturer lec = new Lecturer();
            lec.insertUpdateDeleteStudent('u', lecid, fname, lname, address, contact, room, teachsub); 
        }       
    ...
    private void jButton_Remove1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Remove1ActionPerformed
        if(jTextField_lecid.getText().equals("")){
            JOptionPane.showMessageDialog(null, "No Student Selected");
        }else{
            int lecid = Integer.valueOf(jTextField_lecid.getText());
            lec.insertUpdateDeleteLecturer('d', lecid, null, null, null, null, null, null);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
