...
public class AddInstructorForm extends javax.swing.JFrame {
    ...
    private void jButton_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AddActionPerformed
        ...
        if(verifText()){
            ...
            ins.insertUpdateDeleteInstructor('i', 0, fname, lname, address, contact, room, teachsub);

            InsManage.jTable1.setModel(new DefaultTableModel(null,new Object[]{"Instructor ID", "First Name", "Last Name", "Address",
                                "Contact", "Room", "Teaching Subject"}));
            ins.fillInstructorJtable(InsManage.jTable1, "");
    }
